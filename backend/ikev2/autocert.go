...
//
// So when PG_NODE_IKEV2_DOMAIN is set, the node ignores the certificate
...
const (
	...
	envAutoCertDomain = "PG_NODE_IKEV2_DOMAIN"
	...
	envAutoCertHTTPPort = "PG_NODE_IKEV2_HTTP_PORT"
	// envAutoCertDirectory overrides the ACME directory (for staging tests).
	envAutoCertDirectory = "PG_NODE_IKEV2_ACME_DIRECTORY"

	autoCertDir = "/var/lib/pg-node/certs/ikev2"
