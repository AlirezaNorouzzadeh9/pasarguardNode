...
const (
	...
	BackendType_SINGBOX   BackendType = 5
)
...
type BaseInfoResponse struct {
	...
	// {"xray":"26.3.27","openvpn":"2.6.3","wg":"1.0.20210914"}.
...
type StatsOnlineIpListResponse struct {
	...
	// Per-IP backend the IP is connected through: "xray"|"openvpn"|"wg".
...
const file_common_service_proto_rawDesc = "" +
	...
	"\x04last\x18\x03 \x01(\bR\x04last*U\n" +
	"\vBackendType\x12\b\n" +
	"\x04XRAY\x10\x00\x12\r\n" +
	"\tWIREGUARD\x10\x01\x12\v\n" +
	"\aOPENVPN\x10\x02\x12\t\n" +
	"\x05IKEV2\x10\x03\x12\b\n" +
	"\x04L2TP\x10\x04\x12\v\n" +
	"\aSINGBOX\x10\x05*_\n" +
	"\bStatType\x12\r\n" +
